...
TEST(Ekaterina_Vinyaikina_Test_Circle, constructor_default_test) {
    Circle c;
...
TEST(Ekaterina_Vinyaikina_Test_Circle, constructor_positive_test) {
    Circle c(5);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, setRadius_positive_test) {
    Circle c;
    c.setRadius(7);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, setFerence_positive_test) {
    Circle c;
    c.setFerence(31.4);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, setArea_positive_test) {
    Circle c;
    c.setArea(78.5);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, radius_not_negative_test) {
    ASSERT_THROW(Circle(-1), std::logic_error);
}

TEST(Ekaterina_Vinyaikina_Test_Circle, setRadius_not_negative_test) {
    Circle c;
    ASSERT_THROW(c.setRadius(-1), std::logic_error);
}

TEST(Ekaterina_Vinyaikina_Test_Circle, setFerence_not_negative_test) {
    Circle c;
    ASSERT_THROW(c.setFerence(-1), std::logic_error);
}

TEST(Ekaterina_Vinyaikina_Test_Circle, setArea_not_negative_test) {
    Circle c;
    ASSERT_THROW(c.setArea(-1), std::logic_error);
}

TEST(Ekaterina_Vinyaikina_Test_Circle, zero_radius_test) {
    Circle c(0);
    ASSERT_DOUBLE_EQ(0, c.getRadius());
    ASSERT_DOUBLE_EQ(0, c.getFerence());
    ASSERT_DOUBLE_EQ(0, c.getArea());
...
TEST(Ekaterina_Vinyaikina_Test_Circle, zero_ference_test) {
    Circle c;
    c.setFerence(0);
    ASSERT_DOUBLE_EQ(0, c.getRadius());
    ASSERT_DOUBLE_EQ(0, c.getFerence());
...
TEST(Ekaterina_Vinyaikina_Test_Circle, zero_area_test) {
    Circle c;
    c.setArea(0);
    ASSERT_DOUBLE_EQ(0, c.getRadius());
    ASSERT_DOUBLE_EQ(0, c.getFerence());
...
TEST(Ekaterina_Vinyaikina_Test_Circle, update_radius_test) {
    Circle c(2);
    c.setRadius(3);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, update_ference_test) {
    Circle c(2);
    c.setFerence(37.7);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, update_area_test) {
    Circle c(2);
    c.setArea(50.24);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, large_radius_test) {
    Circle c(1e6);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, large_ference_test) {
    Circle c;
    c.setFerence(1e6);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, large_area_test) {
    Circle c;
    c.setArea(1e12);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, small_radius_test) {
    Circle c(1e-6);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, small_ference_test) {
    Circle c;
    c.setFerence(1e-6);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, small_area_test) {
    Circle c;
    c.setArea(1e-12);
...
TEST(Ekaterina_Vinyaikina_Test_Circle, update_radius_to_zero_test) {
    Circle c(2);
    c.setRadius(0);
    ASSERT_DOUBLE_EQ(0, c.getRadius());
    ASSERT_DOUBLE_EQ(0, c.getFerence());
...
TEST(Ekaterina_Vinyaikina_Test_Circle, update_ference_to_zero_test) {
    Circle c(2);
    c.setFerence(0);
    ASSERT_DOUBLE_EQ(0, c.getRadius());
    ASSERT_DOUBLE_EQ(0, c.getFerence());
...
TEST(Ekaterina_Vinyaikina_Test_Circle, update_area_to_zero_test) {
    Circle c(2);
    c.setArea(0);
    ASSERT_DOUBLE_EQ(0, c.getRadius());
    ASSERT_DOUBLE_EQ(0, c.getFerence());
...
TEST(Ekaterina_Vinyaikina_Test_EarthAndRopeSolve, positive_test) {
...
TEST(Ekaterina_Vinyaikina_Test_EarthAndRopeSolve, zero_growth_test) {
    double earthRadius = 6371.0;
    double growth = 0.0;
    double result = EarthAndRopeSolve(earthRadius, growth);
...
TEST(Ekaterina_Vinyaikina_Test_SwimmingPoolSolve, positive_test) {
